...
const Comment = (props) => {
  ...
  let style = {
    backgroundColor: theme.palette.primary.comment,
    borderRadius: 1.5,
    mb: theme.spacing(2),
  ...
  if (depth % 2 === 1) {
    style.backgroundColor = theme.palette.primary.commentDepth;
  }
      ...
      >
        ...
        {!minimised && (
          <Box sx={{ mt: 1 }} overflow="hidden">
            {!editing ? (
              <div className="ql-editor" dangerouslySetInnerHTML={{ __html: comment.content }}/>
            ) : (
              <ContentUpdateEditor
